...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
    ...
    public FlappyBird() {
        setPreferredSize(new Dimension(boarWidth, boarHeight));
    ...
    public void draw(Graphics g) {
        //background
        g.drawImage(backgroundImg, 0, 0, this.boarWidth, this.boarHeight, null);
